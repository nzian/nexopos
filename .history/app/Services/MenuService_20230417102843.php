        ...
        $this->menus = [
            ...
            'reports' => [
                ...
                'permissions' => [
                    ...
                    'nexopos.reports.vendor-monthly-sales-report'
                ],
                'childrens' => [
                    'sales' => [
                    ...
                    'vendor-monthly-sales-report' => [
                        'label' => __( 'Vendor Sales Report' ),
                        'permissions' => [ 'nexopos.reports.vendor-monthly-sales-report' ],
                        'href' => ns()->url( '/dashboard/reports/vendor-monthly-sales-report' ),
                    ],
                ],
            ],
            'settings' => [
