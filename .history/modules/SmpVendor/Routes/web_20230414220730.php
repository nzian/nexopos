...
Route::get('/reports/vendors-monthly-statement-report', [ VendorReportsController::class, 'showVendorMonthlyStatement' ])->name(ns()->routeName('ns.smp.reports.vendors-monthly-statement'));
