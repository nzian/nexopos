...
Route::prefix('dashboard')->group(function () {
    Route::middleware([
        ...
        Route::get('/reports/vendors-monthly-sales-report', [ VendorReportsController::class, 'showVendorSaleStatement' ])->name(ns()->routeName('smp.reports.vendors-monthly-sale-statement'));
    });
});