...
Route::prefix('smp')->group(function () {
    Route::middleware([
        ...
        Route::post('/reports/vendor-report', [ VendorReportsController::class, 'getVendorReport' ]);
        Route::post('/reports/vendor-sale-report', [ VendorReportsController::class, 'getVendorSaleReport' ]);
    });
});