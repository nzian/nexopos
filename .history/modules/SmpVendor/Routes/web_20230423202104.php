...
Route::prefix('dashboard')->group(function () {
    Route::middleware([
        ...
        Route::get('/vendors/edit/{vendor}', [ VendorsController::class, 'editVendor' ])->name('smp.vendors.edit');
        ...
        Route::get('/reports/vendors-monthly-sales-report', [ VendorReportsController::class, 'showVendorMonthlyStatement' ])->name(ns()->routeName('smp.reports.vendors-monthly-sale-statement'));
    });
});
