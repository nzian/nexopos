                        ...
                        <div class="my-4 flex justify-between w-full">
                            <div class="text-secondary">
                                <ul>
                                    ...
                                    <li class="pb-1 border-b border-dashed">{{ __m( 'Document : Sale Report' ) }}</li>
                                    <li class="pb-1 border-b border-dashed">{{ sprintf( __m( 'By : %s' ), Auth::user()->username ) }}</li>
                                </ul>
                            </div>
                            <div>
                                    ...
                                    <div class="border-b ns-box-body">
                                        <table class="table ns-table w-full">
                                            <tbody class="text-primary">
                                                ...
                                                <tr class="">
                                                    <td width="200" class="font-semibold p-2 border text-left bg-success-secondary border-success-secondary text-white">{{ __m( 'Total' ) }}</td>
                        ...
                        <div class="border-b border-box-edge">
                            <table class="table ns-table w-full">
                                <thead class="text-primary">
                                    <tr>
                                        <th class="border p-2 text-left">{{ __m( 'Products' ) }}</th>
                                        <th width="150" class="border p-2">{{ __m( 'Quantity' ) }}</th>
                                        <th width="150" class="border p-2">{{ __m( 'Discounts' ) }}</th>
                                        <th width="150" class="border p-2">{{ __m( 'Taxes' ) }}</th>
                                        <th width="150" class="border p-2">{{ __m( 'Total' ) }}</th>
                                    </tr>
                                </thead>
                                <tbody class="text-primary">
                    ...
                    <div class="bg-box-background shadow rounded my-4" v-if="reportType.value === 'categories_report'">
                        <div class="border-b border-box-edge">
                            <table class="table ns-table w-full">
                                <thead class="text-primary">
                                    <tr>
                                        <th class="border p-2 text-left">{{ __m( 'Category' ) }}</th>
                                        <th class="border p-2 text-left">{{ __m( 'Product' ) }}</th>
                                        <th width="100" class="border p-2">{{ __m( 'Quantity' ) }}</th>
                                        <th width="150" class="border p-2">{{ __m( 'Discounts' ) }}</th>
                                        <th width="150" class="border p-2">{{ __m( 'Taxes' ) }}</th>
                                        <th width="150" class="border p-2">{{ __m( 'Total' ) }}</th>
                                    </tr>
