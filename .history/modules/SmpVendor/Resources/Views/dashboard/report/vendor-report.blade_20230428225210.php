                            ...
                            <table class="table ns-table w-full">
                                ...
                                <tbody class="text-primary">
                                    <tr v-for="vendor of result" :key="vendor.id">
                                        ...
                                        <td class="p-2 border text-right">@{{ (vendor.commission*vendor.total_sales)/100 | currency }}</td>
                                        <td class="p-2 border text-right">@{{ vendor.monthly_rent | currency }}</td>
                                        <td class="p-2 border text-right">@{{ (vendor.total_sales - ((vendor.commission*vendor.total_sales)/100 +vendor.monthly_rent)) | currency }}</td>
                                    </tr>
                                </tbody>
