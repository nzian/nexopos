                                    ...
                                    <div class="border-b ns-box-body">
                                        <table class="table ns-table w-full">
                                            <tbody class="text-primary">
                                                ...
                                                <tr class="">
                                                    <td width="200" class="font-semibold p-2 border text-left bg-error-secondary text-white">{{ __( 'Shipping' ) }}</td>
                                                    <td class="p-2 border text-right border-success-primary">@{{ summary. | currency }}</td>
                                                </tr>
                                                <tr class="">
