                    ...
                    <div class="bg-box-background shadow rounded my-4" v-if="reportType.value === 'products_report'">
                        <div class="border-b border-box-edge">
                            <table class="table ns-table w-full">
                                ...
                                @{{ let total_subtotal = computeTotal( result, 'total_price' ) -  computeTotal( result, 'tax_value' ) - computeTotal( result, 'discount' ); }}
                                <tfoot class="text-primary font-semibold">
                                    <tr>
                                        ...
                                        <td class="p-2 border text-right text-primary">@{{ total_subtotal  | currency }}</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
