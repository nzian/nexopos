                            ...
                            <table class="table ns-table w-full">
                                ...
                                <tbody class="text-primary">
                                    <tr v-for="vendor of result" :key="vendor.id">
                                        ...
                                        <td class="p-2 border text-right">@{{ vendor.quantity }}</td>
                                        <td class="p-2 border text-right">@{{ vendor.discount | currency }}</td>
                                        <td class="p-2 border text-right">@{{ vendor.tax_value | currency }}</td>
                                        <td class="p-2 border text-right">@{{ vendor.total_price | currency }}</td>
                                    </tr>
                                </tbody>
