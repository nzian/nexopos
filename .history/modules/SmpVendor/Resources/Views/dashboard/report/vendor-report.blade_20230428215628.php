                            ...
                            <table class="table ns-table w-full">
                                ...
                                <tfoot class="text-primary font-semibold">
                                    <tr>
                                        ...
                                        <td class="p-2 border text-right text-primary">@{{ (computeTotal( result, 'total_price' ) - computeTotal( result, 'commission' ) - computeTotal( result, 'monthly_rent' ))  | currency }}</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
