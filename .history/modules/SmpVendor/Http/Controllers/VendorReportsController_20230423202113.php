...
class VendorReportsController extends DashboardController
{
    ...
    public function showVendorSaleStatement()
    {
        return $this->view('SmpVendor::dashboard.report.smp-vendor-report', [
            'title' => __('Vendor Monthly Sales Report'),
            'description' => __('Provides an overview of vendors sales during a specific period'),
        ]);
    }
    ...
    public function getVendorSaleReport(Request $request)
    {
        return $this->reportService
        ->getSmpSaleReport(
            $request->input('startDate'),
