...
class VendorsService
{
    ...
    {
        if ($namespace != null) {
            return @$this->roles[ $namespace ][ 'vendors' ];
        } else {
            return $this->users;
        }
    }
    ...
    {
        collect([
            'username' => fn () => Vendor::where('username', $attributes[ 'username' ]),
            'email' => fn () => Vendor::where('email', $attributes[ 'email' ]),
        ...
        $user->vendor_id = $attributes['vendor_id'];
     ...
     * @param array $roles
     */
    public function setUserRole(Vendor $user, $roles)
    {
     ...
     * @return void
     */
    public function createAttribute(Vendor $user): void
    {
