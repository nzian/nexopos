                ...
                'attribute' =>  [
                    ...
                    'fields' => [
                        [
                            ...
                            'validation' => 'required|unique:users|max:191',
                        ], [
                            'label' => __('Vandor Name'),
                            'name' => 'vendor_name',
                            'value' => Auth::user()->attribute->vendor_name ?? '',
                            'type' => 'text',
                            'description' => __('Enter Vendor name here'),
                        ], [
                            'label' => __('Address 1'),
                            'name' => 'address_1',
                            'value' => Auth::user()->attribute->address_1 ?? '',
                            'type' => 'texxt',
                            'data' => Auth,
