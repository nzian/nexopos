...
const smpVendorSalesReport         =  () => import( './pages/dashboard/reports/smp-vendor-sales-report.vue' );
const smpSalesReport         =  () => import( './pages/dashboard/reports/smp-sales-report.vue' );
