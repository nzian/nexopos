    ...
    <div class="h-full flex-auto flex flex-col" id="pos-container">
        ...
        <div class="flex-auto overflow-hidden flex p-2">
            <div class="flex flex-auto overflow-hidden -m-2">
                ...
                <div :class="visibleSection === 'both' ? 'w-1/2' : 'w-full'" class="p-2 flex overflow-hidden" v-if="[ 'both', 'product' ].includes( visibleSection )">
                    <ns-pos-product></ns-pos-product>
                </div>
            </div>
        </div>
    </div>
...
import nsPosProduct from './ns-pos-product.vue'
